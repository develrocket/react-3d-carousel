...
const CarouselItem = (props) => {
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null,
        React__namespace.createElement("div", { className: styles$1.imageContainer },
            React__namespace.createElement("div", { className: styles$1.firstRowColumn, style: {
                    height: props.height,
                    width: "100%",
                    objectFit: "cover",
                } }, React__namespace.Children.only(props.children)),
            React__namespace.createElement("div", { className: getStyle(props.isShowing, props.outOfFocusDarken) }))));
};
...
const DotsNavigation = (props) => {
    return (React__namespace.createElement(React__namespace.Fragment, null,
        React__namespace.createElement("div", { className: styles.dotsContainer }, props.items &&
            React__namespace.Children.map(props.items, (item, index) => {
...
const { useCallback, useEffect, useState, useImperativeHandle } = React__namespace;
const animationTime = 500; //ms
function delay(time) {
    return new Promise((resolve) => setTimeout(resolve, time));
}
const Carousel = React__namespace.forwardRef((props, ref) => {
    var _a, _b, _c, _d;
    // State
    ...
    const childrenCount = React__namespace.Children.count(props.children);
    const [waiting, setWaiting] = useState(false);
    const [autoScrollClickDelay, setAutoScrollClickDelay] = useState(false);
    const showItemsNum = (_a = React__namespace.Children.count(showItems)) !== null && _a !== void 0 ? _a : 0;
    ...
    useEffect(() => {
        let items = React__namespace.Children.map(props.children, (child, index) => {
            if (child)
                return child;
        });
        if (childrenCount <= 5)
    ...
    const renderElement = (listItem, index) => {
        ...
        return (React__namespace.createElement("div", { className: style, key: index },
            React__namespace.createElement(CarouselItem, { isShowing: isSelected, height: props.height, outOfFocusDarken: (_a = props.outOfFocusDarken) !== null && _a !== void 0 ? _a : true }, listItem)));
    };
    // Swipeable handlers
        ...
        React__namespace.createElement("div", { style: {
            ...
            React__namespace.createElement("div", { className: styles$2.verticalContainer },
                React__namespace.createElement("div", { className: styles$2.horizontalContainer },
                    ...
                    React__namespace.createElement("div", Object.assign({ className: styles$2.swipeContainer }, handlers), showItems &&
                        React__namespace.Children.map(showItems, (listItem, index) => {
            ...
            props.dotsNavigation && (React__namespace.createElement("div", { className: props.dotsNavigationInside
                ...
                React__namespace.createElement(DotsNavigation, { items: childrenCount === 2
                        ? (_b = React__namespace.Children.map(showItems, (el, index) => {
                            if (index < 2)
                                return el;
                        })) !== null && _b !== void 0 ? _b : []
